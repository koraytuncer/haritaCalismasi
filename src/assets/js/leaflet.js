...
!(function (t, i) {
    ...
    return (
      "touchstart" === i
        ? ((u = t),
          ...
          Dt ||
            (document.addEventListener(At, Wt, !0), document.addEventListener(It, Ht, !0), document.addEventListener(Ot, Ft, !0), document.addEventListener(Rt, Ft, !0), (Dt = !0)))
        : "touchmove" === i
  ...
  var qi = {
    ...
    Ki = E.extend({
      ...
      getSize: function () {
        return (
          (this._size && !this._sizeChanged) || ((this._size = new k(this._container.clientWidth || 0, this._container.clientHeight || 0)), (this._sizeChanged = !1)),
          this._size.clone()
        );
      },
      ...
      _handleDOMEvent: function (t) {
        ...
        this._loaded &&
          !Ui(t) &&
          (("mousedown" !== (i = t.type) && "keypress" !== i && "keyup" !== i && "keydown" !== i) || Pi(t.target || t.srcElement), this._fireDOMEvent(t, i));
      },
      _mouseEvents: ["click", "dblclick", "mouseover", "mouseout", "contextmenu"],
      _fireDOMEvent: function (t, i, e) {
        var n;
        if (
          ("click" === t.type && (((n = h({}, t)).type = "preclick"), this._fireDOMEvent(n, n.type, e)), !t._stopped && (e = (e || []).concat(this._findEventTargets(t, i))).length)
        ) {
          var o = e[0];
  ...
  var Ji = Xi.extend({
      ...
      _update: function () {
        ...
        return (
          this.options.hideSingleBase && ((t = t && 1 < n), (this._baseLayersList.style.display = t ? "" : "none")), (this._separator.style.display = i && t ? "" : "none"), this
        );
      },
    ...
    Ce = ze.extend({
      ...
      removeLayer: function (t) {
        return this.hasLayer(t)
          ? (t in this._layers && (t = this._layers[t]), t.removeEventParent(this), ze.prototype.removeLayer.call(this, t), this.fire("layerremove", { layer: t }))
          : this;
      },
      setStyle: function (t) {
    ...
    ke = Me.extend({
      ...
      _initInteraction: function () {
        ...
        this.options.interactive &&
          ...
          Ee &&
            ((t = this.options.draggable), this.dragging && ((t = this.dragging.enabled()), this.dragging.disable()), (this.dragging = new Ee(this)), t && this.dragging.enable()));
      },
  ...
  var on = Me.extend({
    ...
    _tileReady: function (t, i, e) {
      ...
      (e = this._tiles[n]) &&
        ...
        this._noTilesToLoad() &&
          ((this._loading = !1), this.fire("load"), it || !this._map._fadeAnimated ? M(this._pruneTiles, this) : setTimeout(p(this._pruneTiles, this), 250)));
    },
  ...
  var sn = on.extend({
    ...
    getTileUrl: function (t) {
      ...
      return (
        this._map && !this._map.options.crs.infinite && ((i = this._globalTileRange.max.y - t.y), this.options.tms && (e.y = i), (e["-y"] = i)), f(this._url, h(e, this.options))
      );
    },
      ...
      if (!(t.altKey || t.ctrlKey || t.metaKey)) {
        ...
        if (e in this._panKeys)
          (n._panAnim && n._panAnim._inProgress) ||
            ((i = this._panKeys[e]), t.shiftKey && (i = A(i).multiplyBy(3)), n.panBy(i), n.options.maxBounds && n.panInsideBounds(n.options.maxBounds));
